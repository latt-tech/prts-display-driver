...
{
    // 1920 x 1080 @ 60Hz (默认分辨率)
    {
          148500 * KHZ,                                // pixel clock rate [Hz]
        { 148500 * KHZ, 1920 + 88 + 44 + 148 },          // fractional horizontal refresh rate [Hz]
        { 148500 * KHZ, (1920 + 88 + 44 + 148) * (1080 + 4 + 5 + 36) },  // fractional vertical refresh rate [Hz]
        { 1920, 1080 },                                   // (horizontal, vertical) active pixel resolution
        { 1920 + 88 + 44 + 148, 1080 + 4 + 5 + 36 },     // (horizontal, vertical) blanking pixel resolution
        { { 255, 0 } },                                   // video standard and vsync divider
        DISPLAYCONFIG_SCANLINE_ORDERING_PROGRESSIVE
    },
    // 640 x 480 @ 60Hz
    ...
    {
          148500 * KHZ,                                // pixel clock rate [Hz]
        { 148500 * KHZ, 3840 + 88 + 44 + 148 },          // fractional horizontal refresh rate [Hz]
        { 148500 * KHZ, (3840 + 88 + 44 + 148) * (2160 + 4 + 5 + 36) },  // fractional vertical refresh rate [Hz]
        { 3840, 2160 },                                   // (horizontal, vertical) active pixel resolution
        { 3840 + 88 + 44 + 148, 2160 + 4 + 5 + 36 },     // (horizontal, vertical) blanking pixel resolution
        { { 255, 0 } },                                   // video standard and vsync divider
        DISPLAYCONFIG_SCANLINE_ORDERING_PROGRESSIVE
    },
dispinfo(1920, 1200),
...
void IndirectDeviceContext::InitAdapter()
{
    ...
    AdapterCaps.EndPointDiagnostics.pEndPointFriendlyName = L"PRTS Display Adapter";
    AdapterCaps.EndPointDiagnostics.pEndPointManufacturerName = L"Rhodes Island";
    AdapterCaps.EndPointDiagnostics.pEndPointModelName = L"PRTS Display Adapter";
